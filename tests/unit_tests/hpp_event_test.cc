...
class UserEventTest : public ::testing::Test {
protected:
  void SetUp() override
  {
    Realm::enable_unit_tests = true;
...
TEST_F(EventTest, ConstructorAndBasicOperations)
{
  // Default constructor
  HPP::Event event1;
...
TEST_F(EventTest, ComparisonOperators)
{
...
TEST_F(EventTest, NoEventConstant)
{
...
TEST_F(EventTest, HasTriggeredMethod)
{
...
TEST_F(EventTest, ExternalTimedWaitMethod)
{
  // Create a real user event instead of using a hardcoded ID
  HPP::UserEvent user_event = HPP::UserEvent::create_user_event();
  EXPECT_TRUE(user_event.exists());
...
TEST_F(EventTest, HasTriggeredFaultAwareMethod)
{
  // Create a real user event instead of using a hardcoded ID
  HPP::UserEvent user_event = HPP::UserEvent::create_user_event();
  EXPECT_TRUE(user_event.exists());
...
TEST_F(EventTest, ExternalTimedWaitFaultAwareMethod)
{
  // Create a real user event instead of using a hardcoded ID
  HPP::UserEvent user_event = HPP::UserEvent::create_user_event();
  EXPECT_TRUE(user_event.exists());
...
TEST_F(EventTest, SubscribeMethod)
{
...
TEST_F(EventTest, CancelOperationMethod)
{
  HPP::UserEvent event = HPP::UserEvent::create_user_event();
  EXPECT_TRUE(event.exists());
...
TEST_F(EventTest, SetOperationPriorityMethod)
{
  HPP::UserEvent event = HPP::UserEvent::create_user_event();
  EXPECT_TRUE(event.exists());
...
TEST_F(EventTest, AdviseEventOrderingMethods)
{
...
TEST_F(UserEventTest, ConstructorAndBasicOperations)
{
  // Default constructor
...
TEST_F(UserEventTest, CreateUserEventMethod)
{
...
TEST_F(UserEventTest, TriggerMethod)
{
  HPP::UserEvent user_event = HPP::UserEvent::create_user_event();
...
TEST_F(UserEventTest, CancelMethod)
{
  HPP::UserEvent user_event = HPP::UserEvent::create_user_event();
  EXPECT_TRUE(user_event.exists());
...
TEST_F(UserEventTest, NoUserEventConstant)
{
...
TEST_F(EventTest, ImplicitConversion)
{
  HPP::UserEvent user_event = HPP::UserEvent::create_user_event();
  EXPECT_TRUE(user_event.exists());
...
TEST_F(UserEventTest, Inheritance)
{
  HPP::UserEvent user_event = HPP::UserEvent::create_user_event();
  EXPECT_TRUE(user_event.exists());
...
TEST_F(UserEventTest, CreateAndTrigger)
{
  HPP::UserEvent user_event = HPP::UserEvent::create_user_event();
  EXPECT_TRUE(user_event.exists());
...
TEST_F(UserEventTest, TriggerWithNoEvent)
{
  HPP::UserEvent user_event = HPP::UserEvent::create_user_event();
...
TEST_F(UserEventTest, MultipleUserEvents)
{
...
TEST_F(UserEventTest, TriggerAndEventState)
{
  HPP::UserEvent user_event = HPP::UserEvent::create_user_event();
  EXPECT_TRUE(user_event.exists());
